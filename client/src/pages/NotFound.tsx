...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-amber-50 to-stone-100">
      <Card className="w-full max-w-lg mx-4 shadow-lg border-0 bg-amber-50/90 backdrop-blur-sm">
